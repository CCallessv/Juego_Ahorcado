...
-Una funcion que de la palabra secreta
-otra funcion que genere el numero de intento 
- y la otra que tenga la logica del juego bien estructurada sobre lo que se pide 
"""
